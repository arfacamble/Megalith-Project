...
ActiveRecord::Schema.define(version: 2021_06_28_132226) do
  ...
  create_table "chat_messages", force: :cascade do |t|
    t.bigint "trip_chat_box_id", null: false
    t.bigint "user_id", null: false
    t.string "content"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["trip_chat_box_id"], name: "index_chat_messages_on_trip_chat_box_id"
  ...
  create_table "trip_chat_boxes", force: :cascade do |t|
    t.bigint "trip_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["trip_id"], name: "index_trip_chat_boxes_on_trip_id"
  end
  ...
  add_foreign_key "chat_messages", "trip_chat_boxes"
  ...
  add_foreign_key "trip_chat_boxes", "trips"
